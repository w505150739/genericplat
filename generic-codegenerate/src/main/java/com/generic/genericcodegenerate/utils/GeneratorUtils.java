...
import com.generic.common.exception.BusinessException;
import com.generic.common.util.LogUtil;
import com.generic.common.util.constants.GlobalConstants;
import com.generic.common.util.date.DateUtil;
import com.generic.genericcodegenerate.entity.ColumnEntity;
import com.generic.genericcodegenerate.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    private static LogUtil log = LogUtil.getLogger(GeneratorUtils.class);
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtil.getLongDateStr());
        ...
        for(String template : templates){
            //渲染模板
            Template tpl = getTemplate(template, "UTF-8");
            //本地项目生成
            if(genType == GlobalConstants.genType.local.getValue()){
                local(template,tableEntity,tpl,context);
            }
            //web页面生成
            if(genType == GlobalConstants.genType.webDown.getValue()){
                try {
