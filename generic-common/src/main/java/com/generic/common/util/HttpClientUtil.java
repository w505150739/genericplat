package com.generic.common.util;
 ...
 * @date 2018/1/20 23:04
 */
public class HttpClientUtil {

    private static final LogUtil log = LogUtil.getLogger(HttpClientUtil.class);
...
//				entity.setContentEncoding(new BasicHeader(HTTP.CONTENT_TYPE, "application/json"));
                ...
                log.error("UrlEncodedFormEntity Error,encode=" + encode + ",form=", e);
            }
        }
        return httpPost;
    }
